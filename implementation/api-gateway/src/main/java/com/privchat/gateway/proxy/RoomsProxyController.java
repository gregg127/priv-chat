...
@RestController
public class RoomsProxyController {

    private static final Logger log = LoggerFactory.getLogger(RoomsProxyController.class);

    private final RestClient restClient;

    public RoomsProxyController(@Value("${services.rooms.url:http://rooms-service:8080}") String roomsUrl) {
